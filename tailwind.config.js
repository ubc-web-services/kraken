module.exports = {
  ...
  theme: {
    colors: {
      ...
      "unit-primary": "rgba(var(--color-primary), 1)",
      "unit-secondary": "rgba(var(--color-secondary), 1)",
      "unit-tertiary": "rgba(var(--color-tertiary), 1)",
      "unit-accent": "rgba(var(--color-accent), 1)",
      grey: {
